# @patrtorg/dolorem-modi

[![npm version](https://badge.fury.io/js/@patrtorg/dolorem-modi.svg)](https://badge.fury.io/js/@patrtorg/dolorem-modi)
[![downloads count](https://img.shields.io/npm/dt/@patrtorg/dolorem-modi.svg)](https://www.npmjs.com/package/@patrtorg/dolorem-modi)
[![github-ci](https://github.com/patrtorg/dolorem-modi/actions/workflows/testing.yml/badge.svg)](https://github.com/patrtorg/dolorem-modi/actions/workflows/testing.yml)
...
Next, install `@patrtorg/dolorem-modi`:

```bash
npm install -D @patrtorg/dolorem-modi
```
